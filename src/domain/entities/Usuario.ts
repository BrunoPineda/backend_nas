export class Usuario {
  constructor(
    ...
    public readonly dni: string | null = null,
    public readonly apellidoPaterno: string | null = null,
    public readonly apellidoMaterno: string | null = null,
    public readonly username: string | null = null,
    public readonly telefono: string | null = null,
    public readonly numeroDocumento: string | null = null
  ) {}
