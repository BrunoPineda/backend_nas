...
--
-- Requisito: CREATE DATABASE [DB_NAS];  o conexión con -d DB_NAS
-- ============================================
...
INSERT INTO dbo.NASTM_USUARIOS (NO_COMPLETO, DI_CORREO, CO_PASSWORD_HASH, ID_ROL)
SELECT N'Administrador', N'admin@example.com', N'$2b$10$4PrkJ6wXGIRY8eXGO63Rm.JFlHtaGBUu87RQoDqO5T3.rc4vwfVUe', r.ID_ROL
FROM dbo.NASTM_ROLES AS r
WHERE r.NO_ROL = N'ADMIN'
